...
path = "dados/dados_A215_H_2008-06-13_2024-01-01.csv"
...
#df['GLOBAL RADIATION (W/m²)'] = df['GLOBAL RADIATION (Kj/m²)']*conversao
print(df.columns)
df.index = df.index.tz_localize('UTC').tz_convert('America/Belem')
df.to_parquet('dados/dadosLimpos.parquet')
